...
export default class CpsProgressNote extends React.Component {
    ...
    this.formInput = [
      {
        ...
        question: [
          ...
          {
            key: 'cps_date_discussed',
            hint: '',
            title: 'Date & time  Discussed With',
            open: false,
            flag: 2,
            typ: 'date',
            val: '',
          ...
          {
            key: 'current_intervention',
            hint: '',
            title: 'Current Intervention',
            flag: 1,
            val: '',
            option: [],
          },
          {
            key: 'compliance_treatment',
            hint: '',
          ...
          {
            key: 'medication_supervised_by',
            hint: '',
            title: 'Medication supervised by',
            flag: 11,
            val: '',
            option: [],
            others: true,
            key2: 'medication_supervised_by_specify',
            val2: '',
          },
          {
            ...
            subQus: [
              {
                ...
                val: '',
                option: [
                  {id: 'Yes', section_value: 'Per Hour'},
                  {id: 'Yes', section_value: 'Per Day'},
                  {id: 'Yes', section_value: 'Per Month'},
                ],
              },
              {
                key: 'from',
          ...
          },
          {
            key: 'delusions',
            hint: '',
            title2: 'PSYCHOPATOLOGY/MENTAL STATE',
            title: 'Delusions',
            flag: 3,
            typ: 'radio',
            val: '',
          ...
          },
          {
            key: 'behavior',
            hint: '',
            title: 'Disorganized Speech / Behavior',
            flag: 3,
            typ: 'radio',
            val: '',
            option: [
          ...
          {
            key: 'risk_of_other_deliberate',
            hint: '',
            title: 'Risk of deliberate self harm',
            flag: 3,
            typ: 'radio',
            val: '',
            option: [
          ...
          },
          {
            key: 'risk_of_severe',
            hint: '',
            title: 'Risk of severe self-neglect / Serious accidental self-harm',
            flag: 3,
            typ: 'radio',
            val: '',
            option: [
          ...
          },
          {
            key: 'risk_of_harm',
            hint: '',
            title: 'Risk of harm from others / Vulnerability',
            flag: 3,
            typ: 'radio',
            val: '',
            option: [
          ...
          {
            key: 'changes_in_teratment',
            hint: '',
            title: 'Changes in treatment at current visit',
            flag: 4,
            typ: 'text',
            line: 4,
            val: '',
          ...
          {
            key: 'tardive_dystonia',
            hint: '',
            title: 'Tardive dystonia',
            flag: 3,
            typ: 'radio',
            val: '',
            option: [
          ...
          {
            key: 'employment_past_months',
            hint: '',
            title: 'Employment the past 6 month',
            flag: 3,
            typ: 'radio',
            val: '',
            option: [
          ...
          {
            key: 'if_employment_yes',
            hint: '',
            title: '*If Yes',
            flag: 1,
            val: '',
            option: [
              {id: 'Part-time', section_value: 'Part-time'},
              {id: 'Full-time', section_value: 'Full-time'},
              {
                id: 'Un-paid-family worker',
                section_value: 'Un-paid-family worker',
              },
            ],
          },
          ...
          {
            key: 'next_community_visit',
            hint: 'Date',
            title: 'Next community visit',
            open: false,
            flag: 2,
            typ: 'date',
            val: '',
      ...
      e.question.forEach(f => {
        if (f.flag != 5) {
          ...
          if (f.flag == 11 && f.val == '263') {
            ...
            (f.key != 'if_employment_yes' &&
              (!f.val || f.val == '') &&
              f.title) ||
            (if_employment_yes_require &&
              f.key == 'if_employment_yes' &&
              f.val == '')
          ) {
  ...
  componentDidMount() {
    ...
    NetInfo.fetch().then(state => {
      ...
      if (state.isConnected) {
        const {user} = this.context;
        Http.GET('hospital/getServiceByTeamId?email=' + user.user.email)
          .then(r => {
            ...
            if (r.code == 200) {
              ...
              this.formInput[0].question[4].option = r.stafflist
                .map(e => {
                  return {
                    id: e.id,
                    section_value: e.name,
                    branch_id: user.branch.branch_id,
                  };
                })
                .filter(rr => rr.branch_id == user.branch.branch_id);
              this.formInput[0].question[7].option = r.rolelist
                .map(e => {
                  return {
                    id: e.id,
                    section_value: e.name,
              ...
              this.formInput[0].question[13].option = r.stafflist
                .map(e => {
                  return {
                    id: e.id,
                    section_value: e.name,
              ...
              AsyncStorage.setItem(
                'hospital/getServiceByTeamId?email=' + user.user.email,
                JSON.stringify(r.list),
              );
              this.setState({});
            } else {
        ...
        AsyncStorage.getItem(
          ...
          console.log(r);
          if (r) {
            this.formInput[0].question[4].option = JSON.parse(r).filter(
              rr => rr.branch_id == user.branch.branch_id,
            );
            this.formInput[0].question[7].option = JSON.parse(r).filter(
              rr => rr.branch_id == user.branch.branch_id,
            );
            this.formInput[0].question[13].option = JSON.parse(r).filter(
              rr => rr.branch_id == user.branch.branch_id,
            );
            this.setState({});
          }
                  ...
                  ? e.question.map((f, j) => {
                      return (
                        <View style={{marginVertical: 10, marginHorizontal: 5}}>
                          ...
                          <View style={{height: 5}} />
                          {f.flag == 11 &&
                          this.formInput[i].question[j].val == '263' ? (
                            <FormInput
